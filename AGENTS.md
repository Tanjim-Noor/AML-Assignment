...
|       `-- back-matter/
|-- Submission_TP166089/
|   |-- TP166089_AML_Assignment_Report.docx
|   |-- TP166089_AML_Assignment_Report.pdf
|   `-- TP166089_AML_Code_and_Dataset.zip
|-- scripts/
...
- `Submission_TP166089/` contains the final portal-ready PDF and code-and-dataset ZIP, plus the matching editable DOCX retained as a submission backup.
